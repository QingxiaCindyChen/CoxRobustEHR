---
title: "Various Simulations to Compare Cox Regression and Logistic Regression - Censoring"
...
#jpeg("res_sim1_censx_s.jpeg", units="in", width=24, height=18, res=300)
...
#tiff("res_sim1_censx_s.tiff", units="in", width=9, height=6, res=300)
#jpeg("res_sim1_censx_s.jpeg", units="in", width=9, height=6, res=300)
...
#jpeg("bias_sim1_censx_s.jpeg", units="in", width=7, height=4, res=300)
bias_fig
#dev.off()
```

```{r}
result0_censx_s <- result0
result1_censx_s <- result1
result2_censx_s <- result2
result3_censx_s <- result3
result4_censx_s <- result4
```


### Simulation 2 - Exponential, small, censoring (x)
...
#jpeg("res_sim2_censx_s.jpeg", units="in", width=24, height=18, res=300)
# leg <- get_legend(res_fig0)
# res_fig0 <- res_fig0 + theme(legend.position = "none")
# res_fig1 <- res_fig1 + theme(legend.position = "none")
# res_fig2 <- res_fig2 + theme(legend.position = "none")
...
```{r fig.width=9, fig.height=6}
#tiff("res_sim2_censx_s.tiff", units="in", width=9, height=6, res=300)
#jpeg("res_sim2_censx_s.jpeg", units="in", width=9, height=6, res=300)
res_fig(result0, result1, result2, result3, result4)
#dev.off()
```
...
#jpeg("bias_sim2_censx_s.jpeg", units="in", width=7, height=4, res=300)
bias_fig
#dev.off()
```

```{r}
result0_censx_s_sim2 <- result0
result1_censx_s_sim2 <- result1
result2_censx_s_sim2 <- result2
result3_censx_s_sim2 <- result3
result4_censx_s_sim2 <- result4
```
...
#jpeg("res_sim1_censxz_s.jpeg", units="in", width=24, height=18, res=300)
# leg <- get_legend(res_fig0)
# res_fig0 <- res_fig0 + theme(legend.position = "none")
# res_fig1 <- res_fig1 + theme(legend.position = "none")
# res_fig2 <- res_fig2 + theme(legend.position = "none")
...
```{r fig.width=9, fig.height=6}
#tiff("res_sim1_censxz_s.tiff", units="in", width=9, height=6, res=300)
#jpeg("res_sim1_censxz_s.jpeg", units="in", width=9, height=6, res=300)
res_fig(result0, result1, result2, result3, result4)
#dev.off()
```
...
#jpeg("bias_sim1_censxz_s.jpeg", units="in", width=7, height=4, res=300)
bias_fig
#dev.off()
```

```{r}
result0_censxz_s <- result0
result1_censxz_s <- result1
result2_censxz_s <- result2
result3_censxz_s <- result3
result4_censxz_s <- result4
```


### Simulation 2 - Exponential, small, censoring (x & z)
...
#jpeg("res_sim2_censxz_s.jpeg", units="in", width=24, height=18, res=300)
# leg <- get_legend(res_fig0)
# res_fig0 <- res_fig0 + theme(legend.position = "none")
# res_fig1 <- res_fig1 + theme(legend.position = "none")
# res_fig2 <- res_fig2 + theme(legend.position = "none")
...
```{r fig.width=9, fig.height=6}
#tiff("res_sim2_censxz_s.tiff", units="in", width=9, height=6, res=300)
#jpeg("res_sim2_censxz_s.jpeg", units="in", width=9, height=6, res=300)
res_fig(result0, result1, result2, result3, result4)
#dev.off()
```
...
#jpeg("bias_sim2_censxz_s.jpeg", units="in", width=7, height=4, res=300)
bias_fig
#dev.off()
```

```{r}
result0_censxz_s_sim2 <- result0
result1_censxz_s_sim2 <- result1
result2_censxz_s_sim2 <- result2
result3_censxz_s_sim2 <- result3
result4_censxz_s_sim2 <- result4
```
...
#jpeg("res_sim1_censx_l.jpeg", units="in", width=24, height=18, res=300)
# leg <- get_legend(res_fig0)
# res_fig0 <- res_fig0 + theme(legend.position = "none")
# res_fig1 <- res_fig1 + theme(legend.position = "none")
# res_fig2 <- res_fig2 + theme(legend.position = "none")
...
```{r fig.width=9, fig.height=6}
#tiff("res_sim1_censx_l.tiff", units="in", width=9, height=6, res=300)
#jpeg("res_sim1_censx_l.jpeg", units="in", width=9, height=6, res=300)
res_fig(result0, result1, result2, result3, result4)
#dev.off()
```
...
#jpeg("bias_sim1_censx_l.jpeg", units="in", width=7, height=4, res=300)
bias_fig
#dev.off()
```

```{r}
result0_censx_l <- result0
result1_censx_l <- result1
result2_censx_l <- result2
result3_censx_l <- result3
result4_censx_l <- result4
```


### Simulation 2 - Exponential, large, censoring (x)
...
```{r functions-6, warning = FALSE, message = FALSE}
# Generate data
survdata <- function(seed, n, error, p1, mu, sd, alpha_vec, beta_1, beta_vec, lambda, gamma_vec, delta) {
  set.seed(seed) # Set seed
...
**No error**
```{r error0-6, warning = FALSE, message = FALSE}
# Results
result0 <- read.csv('result06.csv', row.names=1)
colnames(result0) <- c("Mean Exposure Rate", "Mean Event Rate", "Bias", "SD", "MSE", "Type I Cox/Power Cox", "Type I logistic (with time)/Power logistic (with time)", "Type I logistic (without time)/Power logistic (without time)", "Type I logistic (with record length)/Power logistic (with record length)")
kable(result0, digits = 4, main = "No Error")
```
...
**Error term is independent of the covariates**
```{r error1-6, warning = FALSE, message = FALSE}
# Results
result1 <- read.csv('result16.csv', row.names=1)
colnames(result1) <- c("Mean Exposure Rate", "Mean Event Rate", "Bias", "SD", "MSE", "Type I Cox/Power Cox", "Type I logistic (with time)/Power logistic (with time)", "Type I logistic (without time)/Power logistic (without time)", "Type I logistic (with record length)/Power logistic (with record length)")
kable(result1, digits = 4, main = "Error Independent")
```
...
**Error term depends on the binary exposure $z$**
```{r error2-6, warning = FALSE, message = FALSE}
# Results
result2 <- read.csv('result26.csv', row.names=1)
colnames(result2) <- c("Mean Exposure Rate", "Mean Event Rate", "Bias", "SD", "MSE", "Type I Cox/Power Cox", "Type I logistic (with time)/Power logistic (with time)", "Type I logistic (without time)/Power logistic (without time)", "Type I logistic (with record length)/Power logistic (with record length)")
kable(result2, digits = 4, main = "Error Dependent on $z$ (Exposure)", escape=FALSE)
```
...
**Error term depends on the binary covariate $x_1$ (confounder)**
```{r error3-6, warning = FALSE, message = FALSE}
# Results
result3 <- read.csv('result36.csv', row.names=1)
colnames(result3) <- c("Mean Exposure Rate", "Mean Event Rate", "Bias", "SD", "MSE", "Type I Cox/Power Cox", "Type I logistic (with time)/Power logistic (with time)", "Type I logistic (without time)/Power logistic (without time)", "Type I logistic (with record length)/Power logistic (with record length)")
kable(result3, digits = 4, main = "Error Dependent on $x_1$ (Confounder)", escape=FALSE)
```
...
**Error term depends on the continuous covariate $x_2$**
```{r error4-6, warning = FALSE, message = FALSE}
# Results
result4 <- read.csv('result46.csv', row.names=1)
colnames(result4) <- c("Mean Exposure Rate", "Mean Event Rate", "Bias", "SD", "MSE", "Type I Cox/Power Cox", "Type I logistic (with time)/Power logistic (with time)", "Type I logistic (without time)/Power logistic (without time)", "Type I logistic (with record length)/Power logistic (with record length)")
kable(result4, digits = 4, main = "Error Dependent on $x_2$", escape=FALSE)
```
...
```{r res_fig6, fig.width=24, fig.height=18}
#jpeg("res_sim2_censx_l.jpeg", units="in", width=24, height=18, res=300)
# leg <- get_legend(res_fig0)
# res_fig0 <- res_fig0 + theme(legend.position = "none")
# res_fig1 <- res_fig1 + theme(legend.position = "none")
# res_fig2 <- res_fig2 + theme(legend.position = "none")
...
```{r fig.width=9, fig.height=6}
#tiff("res_sim2_censx_l.tiff", units="in", width=9, height=6, res=300)
#jpeg("res_sim2_censx_l.jpeg", units="in", width=9, height=6, res=300)
res_fig(result0, result1, result2, result3, result4)
#dev.off()
```
...
#jpeg("bias_sim2_censx_l.jpeg", units="in", width=7, height=4, res=300)
bias_fig
#dev.off()
```

```{r}
result0_censx_l_sim2 <- result0
result1_censx_l_sim2 <- result1
result2_censx_l_sim2 <- result2
result3_censx_l_sim2 <- result3
result4_censx_l_sim2 <- result4
```
...
#jpeg("res_sim1_censxz_l.jpeg", units="in", width=24, height=18, res=300)
# leg <- get_legend(res_fig0)
# res_fig0 <- res_fig0 + theme(legend.position = "none")
# res_fig1 <- res_fig1 + theme(legend.position = "none")
# res_fig2 <- res_fig2 + theme(legend.position = "none")
...
```{r fig.width=9, fig.height=6}
#tiff("res_sim1_censxz_l.tiff", units="in", width=9, height=6, res=300)
#jpeg("res_sim1_censxz_l.jpeg", units="in", width=9, height=6, res=300)
res_fig(result0, result1, result2, result3, result4)
#dev.off()
```
...
#jpeg("bias_sim1_censxz_l.jpeg", units="in", width=7, height=4, res=300)
bias_fig
#dev.off()
```

```{r}
result0_censxz_l <- result0
result1_censxz_l <- result1
result2_censxz_l <- result2
result3_censxz_l <- result3
result4_censxz_l <- result4
```


### Simulation 2 - Exponential, large, censoring (x & z)
...
```{r functions-8, warning = FALSE, message = FALSE}
# Generate data
survdata <- function(seed, n, error, p1, mu, sd, alpha_vec, beta_1, beta_vec, lambda, gamma_vec, delta) {
  set.seed(seed) # Set seed
...
**No error**
```{r error0-8, warning = FALSE, message = FALSE}
# Results
result0 <- read.csv('result08.csv', row.names=1)
colnames(result0) <- c("Mean Exposure Rate", "Mean Event Rate", "Bias", "SD", "MSE", "Type I Cox/Power Cox", "Type I logistic (with time)/Power logistic (with time)", "Type I logistic (without time)/Power logistic (without time)", "Type I logistic (with record length)/Power logistic (with record length)")
kable(result0, digits = 4, main = "No Error")
```
...
**Error term is independent of the covariates**
```{r error1-8, warning = FALSE, message = FALSE}
# Results
result1 <- read.csv('result18.csv', row.names=1)
colnames(result1) <- c("Mean Exposure Rate", "Mean Event Rate", "Bias", "SD", "MSE", "Type I Cox/Power Cox", "Type I logistic (with time)/Power logistic (with time)", "Type I logistic (without time)/Power logistic (without time)", "Type I logistic (with record length)/Power logistic (with record length)")
kable(result1, digits = 4, main = "Error Independent")
```
...
**Error term depends on the binary exposure $z$**
```{r error2-8, warning = FALSE, message = FALSE}
# Results
result2 <- read.csv('result28.csv', row.names=1)
colnames(result2) <- c("Mean Exposure Rate", "Mean Event Rate", "Bias", "SD", "MSE", "Type I Cox/Power Cox", "Type I logistic (with time)/Power logistic (with time)", "Type I logistic (without time)/Power logistic (without time)", "Type I logistic (with record length)/Power logistic (with record length)")
kable(result2, digits = 4, main = "Error Dependent on $z$ (Exposure)", escape=FALSE)
```
...
**Error term depends on the binary covariate $x_1$ (confounder)**
```{r error3-8, warning = FALSE, message = FALSE}
# Results
result3 <- read.csv('result38.csv', row.names=1)
colnames(result3) <- c("Mean Exposure Rate", "Mean Event Rate", "Bias", "SD", "MSE", "Type I Cox/Power Cox", "Type I logistic (with time)/Power logistic (with time)", "Type I logistic (without time)/Power logistic (without time)", "Type I logistic (with record length)/Power logistic (with record length)")
kable(result3, digits = 4, main = "Error Dependent on $x_1$ (Confounder)", escape=FALSE)
```
...
**Error term depends on the continuous covariate $x_2$**
```{r error4-8, warning = FALSE, message = FALSE}
# Results
result4 <- read.csv('result48.csv', row.names=1)
colnames(result4) <- c("Mean Exposure Rate", "Mean Event Rate", "Bias", "SD", "MSE", "Type I Cox/Power Cox", "Type I logistic (with time)/Power logistic (with time)", "Type I logistic (without time)/Power logistic (without time)", "Type I logistic (with record length)/Power logistic (with record length)")
kable(result4, digits = 4, main = "Error Dependent on $x_2$", escape=FALSE)
```
...
```{r res_fig8, fig.width=24, fig.height=18}
#jpeg("res_sim2_censxz_l.jpeg", units="in", width=24, height=18, res=300)
# leg <- get_legend(res_fig0)
# res_fig0 <- res_fig0 + theme(legend.position = "none")
# res_fig1 <- res_fig1 + theme(legend.position = "none")
# res_fig2 <- res_fig2 + theme(legend.position = "none")
...
```{r fig.width=9, fig.height=6}
#tiff("res_sim2_censxz_l.tiff", units="in", width=9, height=6, res=300)
#jpeg("res_sim2_censxz_l.jpeg", units="in", width=9, height=6, res=300)
res_fig(result0, result1, result2, result3, result4)
#dev.off()
```
...
#jpeg("bias_sim2_censxz_l.jpeg", units="in", width=7, height=4, res=300)
bias_fig
#dev.off()
```

```{r}
result0_censxz_l_sim2 <- result0
result1_censxz_l_sim2 <- result1
result2_censxz_l_sim2 <- result2
result3_censxz_l_sim2 <- result3
result4_censxz_l_sim2 <- result4
```
